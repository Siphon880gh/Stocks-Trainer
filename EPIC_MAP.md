...
- Cloud LLM coach, fees/fills sim, live options chains
...
- **Errors:** Missing pack, corrupt progress → reset; locked milestone → show prerequisite
...
| E1 | Equities Sample Universe | Credible equity packs for charts/cases (multi-asset UI later) | MVP | Next |
...
| E7 | Practice Draw Completion | Draw-to-learn feedback | Later | Deferred |
| E8 | Live/Delayed Market Data & Accounts | Real markets + sync | Later | Deferred |
...
| Multi-market browse / cross-market | E1.M2, E4.M3 (post-MVP) |
| Candles + indicator lines | E4.M0 (+ existing Training); E4.M3 expands |
| Market-type literacy | E4.M1 (+ risk/horizon) |
